...
public class Simulation extends ApplicationAdapter implements InputProcessor {
	...
	public void create () {
		...
		// map = new TmxMapLoader().load("custom-traps-easy.tmx");
		// map = new TmxMapLoader().load("custom-traps-hard.tmx");
		// map = new TmxMapLoader().load("custom-combined-easy.tmx");
		// map = new TmxMapLoader().load("custom-combined-hard.tmx");
		map = new TmxMapLoader().load("custom-deadend-space2.tmx");
		// map = new TmxMapLoader().load("custom-deadend-space3.tmx");
		// map = new TmxMapLoader().load("custom-deadend-space4.tmx");
		// map = new TmxMapLoader().load("custom-deadend-space-all.tmx");
